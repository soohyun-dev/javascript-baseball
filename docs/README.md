...
- [x] 만약 Input 값이 예외사항에 해당할 경우 `1 ~ 9 올바른 숫자 3개를 입력하셔야합니다. 게임을 종료합니다.` 를 출력한 뒤 프로그램을 종료한다. <br>
...
- [x] 입력된 Input 길이가 1이 아닌 경우.
- [x] 위와 같은 잘못된 값을 사용자가 입력한 경우 throw 문을 사용해 예외 발생시킨 후 애플리케이션 종료.<br>
      <br>
...
- [x] 만약 Input 값이 예외사항에 해당할 경우 `1.재시작 2.게임 종료 두 번호 중 하나만 입력하셔야합니다. 게임을 종료합니다.` 를 출력한 뒤 프로그램을 종료한다. <br>
      <br>

### ⛔ 에러 메시지 기능

- [x] GAME_NUMBER: `1 ~ 9 올바른 숫자 3개를 입력하셔야합니다. 게임을 종료합니다.`
- [x] RESTART: `1.재시작 2.게임 종료 두 번호 중 하나만 입력하셔야합니다. 게임을 종료합니다.`,<br>
      <br>
